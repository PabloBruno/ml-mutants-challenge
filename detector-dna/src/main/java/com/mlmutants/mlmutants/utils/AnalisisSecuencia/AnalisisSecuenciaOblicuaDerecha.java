...
public class AnalisisSecuenciaOblicuaDerecha implements AnalisisSecuenciaDireccion{
    ...
    public Boolean isAnalizable(String [] dna, int col, int row, int numSecuenciaAdn) {
        return (dna.length - row) >= numSecuenciaAdn && (dna[row].length() - col) >= numSecuenciaAdn;
    }
}
